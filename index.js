...
import { copyObject, createArray, getClampedNumber, getContainedNumber } from "./libs/utils.mjs";
import { ObjectMatrix } from "./libs/object-matrix.mjs";
...
class ObjectView extends ObjectMatrix {
  constructor(obj) {
    ...
    const origProperties = Object.keys(overrideProperties)
      .reduce((acc, cur) => {
